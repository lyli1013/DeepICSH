...
if __name__ == "__main__":
    ...
    for train_index, test_index in folds.split(X_kmer, Y_kmer):
        ...
        if model_ind == "connection":
            ...
            dataframe.to_csv(checkpoint_dir + "/HepG2_ourmethod" + str(count_iter) + ".csv", index=False, sep=',')
    ...
    dataframe.to_csv(checkpoint_dir + "/HepG2_ourmethod_average.csv", index=False, sep=',')
