...
if __name__ == "__main__":
    ...
    for epoch in EPCOHS:
        checkpoint_dir = '/data/lyli/Silencer/HepG2/datasets/1679/12D/data_n=20/model/autoencode'  # Store model files
        if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
            os.mkdir(checkpoint_dir)
    
        checkpoint_dir = '/data/lyli/Silencer/HepG2/datasets/1679/12D/data_n=20/model/autoencode/' + 'eopchis' + str(
