...
checkpoint_dir = '/data/lyli/Silencer/HepG2/datasets/1679/12D/data_n=20/model/checkpoints_4layer_' + str(encode_epochs) + '-/DNA_model'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)
...
if __name__ == "__main__":
    ...
    dataframe.to_csv(checkpoint_dir + "HepG2_our_only-seq_method_average.csv", index=False, sep=',')
